...
1. فایل نوت‌بوک آماده را باز کنید: `notebooks/telegram_to_gdrive_colab.ipynb`
2. آن را در **Google Colab** اجرا کنید.
3. با وارد کردن اطلاعات اکانت تلگرام خود (API ID / API HASH / شماره تلفن)، فایل موردنظر را دانلود کنید.
4. فایل دانلودشده مستقیم داخل **Google Drive** شما ذخیره می‌شود.
